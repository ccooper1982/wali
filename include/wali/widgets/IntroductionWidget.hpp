...
inline static constexpr auto intro_waffle = R"(
  <ul>
    <li>Apart from creating partitions, no changes are applied until 'Install' is pressed in the final step</li>
    <li>The Install button is disabled until the configuration is valid</li>
    <li>WALI does not offer 'profiles' yet</li>
  </ul>
  <p>If in doubt, check the Arch install guide.</p>
  <b>Useful Links</b>
  <ul>
    <li><a href="https://wiki.archlinux.org/title/Installation_guide" target="_blank">Install Guide</a></li>
